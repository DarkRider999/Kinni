...
object FeatureExplainer {
    private val topics = linkedMapOf(
        ...
        "crossfade" to (listOf("crossfade", "auto fader", "autofader", "fade") to "The auto-fader fades the current song out over 3 s and the next one in over 3 s. Crossfade overlaps them instead; you can set 0–12 s in Settings."),
